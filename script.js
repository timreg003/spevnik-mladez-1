...
function processXML(xmlText) {
    ...
    // RADENIE: Čísla -> Mariánske -> Ostatné
    songs.sort((a, b) => {
...
function openSongById(id, source) {
    ...
    // Ak otvárame zo zoznamu "Všetky", nastavíme navigáciu na všetky
    if (source === 'all') {
        currentModeList = [...songs];
    }
